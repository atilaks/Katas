...
class TestAgent(unittest.TestCase):
    ...
    def test_define_agent(self):
        ...
        expected = {"name": "José", "surname": "García", "passport": "56475215f",
                    "police id": "A5826", "department": "departmentA", "manager": True}

        # Act
        full_agent_description = self.department_manager.full_description
    ...
    def test_manager_modification(self):
        # Arrange
        expected = False
        self.department_manager.manager = False
